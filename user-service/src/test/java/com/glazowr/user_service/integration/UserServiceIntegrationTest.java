package com.glazowr.user_service.integration;
...
import com.glazowr.user_service.testsupport.MySqlTestcontainersBase;
...
public class UserServiceIntegrationTest extends MySqlTestcontainersBase {
    ...
    void createUser_viaRestApi_persistsAndReturnsUser() {
        ...
        assertThat(response.getBody().getEmail()).isEqualTo("glazowr@gmail.com");
        ...
        assertThat(loaded.getBody().getEmail()).isEqualTo("glazowr@gmail.com");
    }
