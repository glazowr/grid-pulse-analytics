package com.glazowr.device_service.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI deviceServiceApiDocs() {
        return new OpenAPI()
                .info(new io.swagger.v3.oas.models.info.Info()
                        ...
                        .description("Device service API for Grid Pulse Analytics Project")
                        .contact(getContact())
                        .license(getLicense())
                        .version("1.0.0"));
    }
    ...
    private static Contact getContact() {
        ...
        contact.setUrl("https://glazowr.com");
        contact.setEmail("glazowr@gmail.com");
        return contact;
    }
}